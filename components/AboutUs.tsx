...
export const AboutUs: React.FC<{ onBack: () => void }> = ({ onBack }) => {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-slate-200">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-dark-surface/50 about-outcomes-wrapper">
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="about-awards-container bg-dark-card border border-white/10 rounded-2xl overflow-hidden">
