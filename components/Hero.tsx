...
export const Hero: React.FC<HeroProps> = ({ activeMenu = 'home' }) => {
  ...
  const fallbackContent: HeroContent = {
    ...
    hero_description: 'My name is Lyhoeng..., I craft user-centered digital products that blend aesthetics with functionality. Specializing in SaaS interfaces, mobile apps, and design systems.',
