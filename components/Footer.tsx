...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-white/10 bg-dark-surface py-8 sm:py-10 md:py-12">
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-8 sm:mb-10 md:mb-12">
            <div className="col-span-1 md:col-span-2">
                 <a href="#" className="flex items-center gap-2 group mb-4">
                    <Hexagon className="text-gold-gradient w-6 h-6 fill-gold-gradient/20" />
                    <span className="text-lg font-bold tracking-wider font-mono text-white">
                        LYHOENG<span className="text-gold-gradient">-DESIGN</span>
                    </span>
                </a>
                <p className="text-slate-400 max-w-sm text-sm leading-relaxed">
                    A portfolio showcasing user-centered design solutions. 
                    Crafting interfaces that are not only visually stunning but also intuitive and accessible.
                </p>
            </div>

            <div>
                <h4 className="text-white font-bold mb-4 font-mono uppercase text-sm">Navigation</h4>
                <ul className="space-y-2 text-sm text-slate-400">
                    <li><a href="#work" className="hover:text-gold-gradient transition-colors">Portfolio</a></li>
                    <li><a href="#services" className="hover:text-gold-gradient transition-colors">Services</a></li>
                    <li><a href="#about" className="hover:text-gold-gradient transition-colors">About</a></li>
                    <li><a href="#contact" className="hover:text-gold-gradient transition-colors">Contact</a></li>
                </ul>
            </div>

            <div>
                <h4 className="text-white font-bold mb-4 font-mono uppercase text-sm">Socials</h4>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
            <p>&copy; 2025 LYHOENG-DESIGN. All rights reserved.</p>
