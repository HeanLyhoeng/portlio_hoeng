...
export const Header: React.FC = () => {
  ...
  const navLinks = [
    ...
    { name: 'Resources', href: '#resources', isPage: false },
  ];
  ...
  const handleNavClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string, isPage: boolean, isHome?: boolean) => {
    ...
    if (isHome) {
      ...
      const isOnDifferentPage = currentHash && (currentHash.startsWith('#/project/') || currentHash.startsWith('#/design/') || currentHash === '#/about' || currentHash === '#/services' || currentHash === '#/software-sales');
      ...
      >
        <div className="max-w-[1024px] mx-auto px-6 sm:px-8">
          <div className="flex items-center justify-between h-10 sm:h-11">
            ...
            <a 
              href="#/" 
              className="text-xs sm:text-sm font-medium tracking-wide transition-opacity duration-300 hover:opacity-80"
